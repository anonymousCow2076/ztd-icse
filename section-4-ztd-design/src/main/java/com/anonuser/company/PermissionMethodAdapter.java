...
//        If it's invoking constructor of FileReader, we substitute with PermFileReader
        if (owner.equals("java/io/FileReader") && name.equals("<init>")) {
            mv.visitMethodInsn(opcode, "com/anonuser/asm/filepractice/permissions/PermFileReader", name, descriptor, isInterface);
        } else {
    ...
    public void visitTypeInsn(int opcode, String type) {
        ...
        if (type.equals("java/io/FileReader")) {
            mv.visitTypeInsn(opcode, "com/anonuser/asm/filepractice/permissions/PermFileReader");
